 ...
 * 2017-09-20T18:12:00.026+08:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "WebInterface", 
                  wsdlLocation = "http://192.168.22.83:9020/WebInterface.asmx?wsdl",
...
public class WebInterface extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.22.83:9020/WebInterface.asmx?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WebInterface.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.22.83:9020/WebInterface.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
