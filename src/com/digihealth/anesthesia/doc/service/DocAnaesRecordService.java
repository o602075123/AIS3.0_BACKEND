...
public class DocAnaesRecordService extends BaseService {
	...
	public void changeAnaesRecordState(DocAnaesRecord anaesRecord) {
		...
		if (StringUtils.isNotBlank(anaesRecord.getOptLevel()) && !anaesRecord.getOptLevel().equals(regOpt.getOptLevel()))
        {
            regOpt.setOptLevel(anaesRecord.getOptLevel());
        ...
        /*if (null != oldAnaesRecord.getFlow1() && null == anaesRecord.getFlow1())
        {
            oldAnaesRecord.setFlow1(null);
        }
        if (null != oldAnaesRecord.getFlow2() && null == anaesRecord.getFlow2())
        {
            oldAnaesRecord.setFlow2(null);
        }*/
        
        docAnaesRecordDao.updateByPrimaryKeySelective(oldAnaesRecord);
	...
	@Transactional
    public void updateFlow(DocAnaesRecord anaesRecord){
        docAnaesRecordDao.updateFlow(anaesRecord.getFlow1(), anaesRecord.getFlow2(),anaesRecord.getRegOptId());
    }
