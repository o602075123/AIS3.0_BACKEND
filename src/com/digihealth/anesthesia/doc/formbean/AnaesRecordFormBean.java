...
public class AnaesRecordFormBean
{
    /**
     * 麻醉记录单主键
     */
    ...
    @ApiModelProperty(value = "药物维持")
    private String medicineKeep;
	
    @ApiModelProperty(value = "镇痛用药配方1流速（黔南州）")
    private Float flow1;
    
    @ApiModelProperty(value = "镇痛用药配方1流速单位（黔南州）")
    private String flowUnit1;
    
    @ApiModelProperty(value = "镇痛用药配方2流速（黔南州）")
    private Float flow2;
    
    @ApiModelProperty(value = "镇痛用药配方2流速单位（黔南州）")
