...
public class DocOptCareRecord {
    ...
    @ApiModelProperty(value = "手术室交班护士集合")
     private List<String> shiftChangedNurseList;
    
    @ApiModelProperty(value = "病房接班护士集合")
	...
	{
		this.sickroomJiaoNurse = sickroomJiaoNurse == null ? null : sickroomJiaoNurse.trim();
	}
	...
	{
		this.operrommJieNurse = operrommJieNurse == null ? null : operrommJieNurse.trim();
	}
