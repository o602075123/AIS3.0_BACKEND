...
public class DocPreVisit {
    ...
    @ApiModelProperty(value = "手术麻醉史")
    private Map<String, Object> anaesCondMap;
    
    @ApiModelProperty(value = "手术史")
    private Map<String, Object> operHisCondMap;

    @ApiModelProperty(value = "穿刺部位详情")
    private Map<String, Object> anaesPunctureCondMap;
    ...
    public Map<String, Object> getAssistMeasureMap()
    {
        return assistMeasureMap;
    }

    public void setAssistMeasureMap(Map<String, Object> assistMeasureMap)
    {
    ...
    public void setAnaesCondMap(Map<String, Object> anaesCondMap)
    {
        this.anaesCondMap = anaesCondMap;
    }

    public Map<String, Object> getOperHisCondMap()
    {
        return operHisCondMap;
    }

    public void setOperHisCondMap(Map<String, Object> operHisCondMap)
    {
        this.operHisCondMap = operHisCondMap;
    }

    public Map<String, Object> getAnaesPunctureCondMap()
    {
        return anaesPunctureCondMap;
    }

    public void setAnaesPunctureCondMap(Map<String, Object> anaesPunctureCondMap)
    {
        this.anaesPunctureCondMap = anaesPunctureCondMap;
    }
