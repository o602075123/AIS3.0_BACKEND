...
public class DocSpinalCanalPuncture {
     ...
     * 阻力消失
     */
    @ApiModelProperty(value = "硬膜外穿刺")
	private Integer duralPuncture;
	
    /**
     * 阻力消失
     */
    @ApiModelProperty(value = "腰椎穿刺")
	private Integer lumbarPuncture;
    ...
    public Integer getDuralPuncture()
    {
        return duralPuncture;
    }

    public void setDuralPuncture(Integer duralPuncture)
    {
        this.duralPuncture = duralPuncture;
    }

    public Integer getLumbarPuncture()
    {
        return lumbarPuncture;
    }

    public void setLumbarPuncture(Integer lumbarPuncture)
    {
        this.lumbarPuncture = lumbarPuncture;
    }
}