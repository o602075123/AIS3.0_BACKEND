...
public class DocAnaesPlan {
     ...
     * 其他特殊操作
     */
    @ApiModelProperty(value = "其他特殊操作")
    private String specialOperateOther;
     ...
     * 其他诱导方法
     */
    private String inductionMethodOther;

    /**
     * 气管插管
     */
    private Integer tracheaIntuba;

    /**
     * 气管插管其他
     */
    private String tracheaIntubaOther;

    /**
     * 其他穿刺点
     */
    private String puncPointOther;

    /**
     * 臂丛神经阻滞其他
     */
    private String nerveBlockAnesOther;

    /**
     * 其他神经阻滞方法
     */
    private String nerveBlockOther;
     ...
     * 麻醉前用药
     */
    private String beforeAnaesMedical;

    /**
     * 气管插管钳
     */
    private Integer tracheaIntubaForceps;

    /**
     * 口咽通气道
     */
    private Integer oropharyngealAirways;

    /**
     * 鼻咽通气道ID
     */
    private String nasopharyngealAirways;

    /**
     * 双腔气管导管数量
     */
    private Integer doubleChamberAmout;

    /**
     * 双腔气管导管型号
     */
    private String doubleChamberModel;

    /**
     * 支气管堵塞导管
     */
    private Integer bronchialOccluder;

    /**
     * 深静脉穿刺包部位
     */
    private String deepVeniPunctureBagSite;

    /**
     * 深静脉穿刺包数量
     */
    private Integer deepVeniPunctureBagAmount;

    /**
     * 静脉注射泵数量
     */
    private Integer intravenousPump;

    /**
     * 细静脉延长管数量
     */
    private Integer venousExtensionTube;

    /**
     * 三通接头数量
     */
    private Integer teeFitting;
     ...
     * 冷沉淀
     */
    private Integer coldPrecipitate;
     ...
     * 可能出现的问题和对策
     */
    private String problemAndMethod;
    
    /**
     * 心功能分级
     */
    private Integer nyha;
     ...
     * 麻醉适应症
     */
    private Integer anaesIndications;
    
    private List<String> localAnestList;  //局麻药
    private List<String> sedativesList;  //镇静药
    private List<String> analgesicsList;  //镇痛药
    private List<String> muscleRelaxantList;  //静脉全麻药
    private List<String> intravenousAnestList;  //肌松药
    private List<String> inhalationAnestList;  //吸入麻醉药
    private List<String> aidMedicationList;  //急救药
    private List<String> beforeAnaesMedicalList;  //麻醉前用药
    private List<String> infusionList;  //输液
    
    private List<AnalgesicPumpFormbean> analgesicPumpMethodList; //镇痛泵配方

	public List<AnalgesicPumpFormbean> getAnalgesicPumpMethodList()
    {
        return null == analgesicPumpMethodList ? new ArrayList<AnalgesicPumpFormbean>() : analgesicPumpMethodList;
    }

    public void setAnalgesicPumpMethodList(List<AnalgesicPumpFormbean> analgesicPumpMethodList)
    {
        this.analgesicPumpMethodList = analgesicPumpMethodList;
    }

    public List<String> getInfusionList()
    {
        return null == infusionList ? new ArrayList<String>() :infusionList;
    }

    public void setInfusionList(List<String> infusionList)
    {
        this.infusionList = infusionList;
    }

    public List<String> getLocalAnestList()
    {
        return null == localAnestList ? new ArrayList<String>() : localAnestList;
    }

    public void setLocalAnestList(List<String> localAnestList)
    {
        this.localAnestList = localAnestList;
    }

    public List<String> getSedativesList()
    {
        return null == sedativesList ? new ArrayList<String>() : sedativesList;
    }

    public void setSedativesList(List<String> sedativesList)
    {
        this.sedativesList = sedativesList;
    }

    public List<String> getAnalgesicsList()
    {
        return null == analgesicsList ? new ArrayList<String>() : analgesicsList;
    }

    public void setAnalgesicsList(List<String> analgesicsList)
    {
        this.analgesicsList = analgesicsList;
    }

    public List<String> getMuscleRelaxantList()
    {
        return null == muscleRelaxantList ? new ArrayList<String>() : muscleRelaxantList;
    }

    public void setMuscleRelaxantList(List<String> muscleRelaxantList)
    {
        this.muscleRelaxantList = muscleRelaxantList;
    }

    public List<String> getIntravenousAnestList()
    {
        return null == intravenousAnestList ? new ArrayList<String>() : intravenousAnestList;
    }

    public void setIntravenousAnestList(List<String> intravenousAnestList)
    {
        this.intravenousAnestList = intravenousAnestList;
    }

    public List<String> getInhalationAnestList()
    {
        return null == inhalationAnestList ? new ArrayList<String>() : inhalationAnestList;
    }

    public void setInhalationAnestList(List<String> inhalationAnestList)
    {
        this.inhalationAnestList = inhalationAnestList;
    }

    public List<String> getAidMedicationList()
    {
        return null == aidMedicationList ? new ArrayList<String>() : aidMedicationList;
    }

    public void setAidMedicationList(List<String> aidMedicationList)
    {
        this.aidMedicationList = aidMedicationList;
    }

    public List<String> getBeforeAnaesMedicalList()
    {
        return null == beforeAnaesMedicalList ? new ArrayList<String>() : beforeAnaesMedicalList;
    }

    public void setBeforeAnaesMedicalList(List<String> beforeAnaesMedicalList)
    {
        this.beforeAnaesMedicalList = beforeAnaesMedicalList;
    }
    ...
    public String getInductionMethodOther()
    {
        return inductionMethodOther;
    }

    public void setInductionMethodOther(String inductionMethodOther)
    {
        this.inductionMethodOther = inductionMethodOther;
    }

    public Integer getTracheaIntuba()
    {
        return tracheaIntuba;
    }

    public void setTracheaIntuba(Integer tracheaIntuba)
    {
        this.tracheaIntuba = tracheaIntuba;
    }

    public String getTracheaIntubaOther()
    {
        return tracheaIntubaOther;
    }

    public void setTracheaIntubaOther(String tracheaIntubaOther)
    {
        this.tracheaIntubaOther = tracheaIntubaOther;
    }

    public String getPuncPointOther()
    {
        return puncPointOther;
    }

    public void setPuncPointOther(String puncPointOther)
    {
        this.puncPointOther = puncPointOther;
    }

    public String getNerveBlockAnesOther()
    {
        return nerveBlockAnesOther;
    }

    public void setNerveBlockAnesOther(String nerveBlockAnesOther)
    {
        this.nerveBlockAnesOther = nerveBlockAnesOther;
    }

    public String getNerveBlockOther()
    {
        return nerveBlockOther;
    }

    public void setNerveBlockOther(String nerveBlockOther)
    {
        this.nerveBlockOther = nerveBlockOther;
    }
    ...
    public String getBeforeAnaesMedical()
    {
        return beforeAnaesMedical;
    }

    public void setBeforeAnaesMedical(String beforeAnaesMedical)
    {
        this.beforeAnaesMedical = beforeAnaesMedical;
    }

    public Integer getTracheaIntubaForceps()
    {
        return tracheaIntubaForceps;
    }

    public void setTracheaIntubaForceps(Integer tracheaIntubaForceps)
    {
        this.tracheaIntubaForceps = tracheaIntubaForceps;
    }

    public Integer getOropharyngealAirways()
    {
        return oropharyngealAirways;
    }

    public void setOropharyngealAirways(Integer oropharyngealAirways)
    {
        this.oropharyngealAirways = oropharyngealAirways;
    }

    public String getNasopharyngealAirways()
    {
        return nasopharyngealAirways;
    }

    public void setNasopharyngealAirways(String nasopharyngealAirways)
    {
        this.nasopharyngealAirways = nasopharyngealAirways;
    }

    public Integer getDoubleChamberAmout()
    {
        return doubleChamberAmout;
    }

    public void setDoubleChamberAmout(Integer doubleChamberAmout)
    {
        this.doubleChamberAmout = doubleChamberAmout;
    }

    public String getDoubleChamberModel()
    {
        return doubleChamberModel;
    }

    public void setDoubleChamberModel(String doubleChamberModel)
    {
        this.doubleChamberModel = doubleChamberModel;
    }

    public Integer getBronchialOccluder()
    {
        return bronchialOccluder;
    }

    public void setBronchialOccluder(Integer bronchialOccluder)
    {
        this.bronchialOccluder = bronchialOccluder;
    }

    public String getDeepVeniPunctureBagSite()
    {
        return deepVeniPunctureBagSite;
    }

    public void setDeepVeniPunctureBagSite(String deepVeniPunctureBagSite)
    {
        this.deepVeniPunctureBagSite = deepVeniPunctureBagSite;
    }

    public Integer getDeepVeniPunctureBagAmount()
    {
        return deepVeniPunctureBagAmount;
    }

    public void setDeepVeniPunctureBagAmount(Integer deepVeniPunctureBagAmount)
    {
        this.deepVeniPunctureBagAmount = deepVeniPunctureBagAmount;
    }

    public Integer getIntravenousPump()
    {
        return intravenousPump;
    }

    public void setIntravenousPump(Integer intravenousPump)
    {
        this.intravenousPump = intravenousPump;
    }

    public Integer getVenousExtensionTube()
    {
        return venousExtensionTube;
    }

    public void setVenousExtensionTube(Integer venousExtensionTube)
    {
        this.venousExtensionTube = venousExtensionTube;
    }

    public Integer getTeeFitting()
    {
        return teeFitting;
    }

    public void setTeeFitting(Integer teeFitting)
    {
        this.teeFitting = teeFitting;
    }
    ...
    public Integer getColdPrecipitate()
    {
        return coldPrecipitate;
    }

    public void setColdPrecipitate(Integer coldPrecipitate)
    {
        this.coldPrecipitate = coldPrecipitate;
    }
    ...
    public String getProblemAndMethod()
    {
        return problemAndMethod;
    }

    public void setProblemAndMethod(String problemAndMethod)
    {
        this.problemAndMethod = problemAndMethod;
    }

    public String getSpecialOperateOther()
    {
        return specialOperateOther;
    }

    public void setSpecialOperateOther(String specialOperateOther)
    {
        this.specialOperateOther = specialOperateOther;
    }
    ...
    public Integer getAnaesIndications()
    {
        return anaesIndications;
    }

    public void setAnaesIndications(Integer anaesIndications)
    {
        this.anaesIndications = anaesIndications;
    }
}