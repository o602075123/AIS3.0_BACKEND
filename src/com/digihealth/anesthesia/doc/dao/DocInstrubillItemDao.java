...
public interface DocInstrubillItemDao {
	 ...
	 * @return
	 */
	public List<DocInstrubillItem> searchInstrubillItemByRegOptId(@Param("regOptId") String regOptId,  @Param("type") String type);
	...
	public DocInstrubillItem searchInstrubillItemByCodeAndRegOptId(@Param("regOptId") String regOptId,@Param("instrumentId") String instrumentId,  @Param("type") String type);
