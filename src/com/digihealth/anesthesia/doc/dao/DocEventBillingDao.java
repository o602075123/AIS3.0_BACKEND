...
public interface DocEventBillingDao extends CrudDao<DocEventBilling>{
	...
	public List<DocEventBilling> selectEventBillingBySource(@Param("regOptId")String regOptId,@Param("costType")String costType,@Param("source")String source, @Param("beid") String beid);
	
	public int updateChargeState(@Param("ebId")String ebId);
	
	public List<OperCost> queryUnCostListByRegOptId(@Param("regOptId")String regOptId,@Param("costType")String costType);
	
	public List<ChargItem> queryUnChargMedByRegOptId(@Param("regOptId")String regOptId);
	
	public Integer checkEventBillingSyn(@Param("regOptId")String regOptId,@Param("costType")String costType);
	
	public Float queryShouldCostByRegOptId(@Param("regOptId")String regOptId,@Param("costType")String costType);
	
	public int updateChargeStateByMedId(@Param("medId")String medId, @Param("regOptId")String regOptId);
