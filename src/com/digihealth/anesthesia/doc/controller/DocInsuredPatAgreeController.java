...
public class DocInsuredPatAgreeController extends BaseController
{
    ...
    public String searchInsuredPatAgreeByRegOptId(@ApiParam(name="map", value ="查询参数") @RequestBody Map map)
    {
        ...
        if ("NO_END".equals(docInsuredPatAgree.getProcessState()))
        {
            ...
            {
                docInsuredPatAgree.setDocSign(shiftChangeList.get(shiftChangeList.size() - 1).getShiftChangePeopleId());
            }
        }
        ...
        resp.put("insuredPatAgree",docInsuredPatAgree);
