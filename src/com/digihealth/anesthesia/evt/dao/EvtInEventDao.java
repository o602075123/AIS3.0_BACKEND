...
public interface EvtInEventDao {
	...
	public Integer getIoeventCountValueByIoDef(@Param("docId")String docId, @Param("ioDefId")String ioDefId, @Param("subType")String subType);
	
	public String seleteIoeventSumByDocId(@Param("docId")String docId,@Param("beid")String beid);
	...
	public List<SearchOptOperIoevent> queryIoeventTotal(@Param("searchBean") SearchFormBean searchBean);
}