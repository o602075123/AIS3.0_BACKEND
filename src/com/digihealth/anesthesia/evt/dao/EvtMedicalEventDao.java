...
public interface EvtMedicalEventDao {
	...
	//查询手术人员用药信息后根据药品code进行分组查询
    public List<RegOptOperMedicaleventFormBean> getMedicalGroupByNameListQNZ(@Param("searchBean")SearchFormBean searchBean);
	
	//查询手术人员用药信息后根据药品code进行分组查询
    public List<RegOptOperMedicaleventFormBean> getMedicalGroupByNameListNHFE(@Param("searchBean")SearchFormBean searchBean);
	...
	public List<String> searchNoEndTimeList(@Param("docId")String docId);
}