...
public class EvtMedicalEventDetail {
    ...
    @ApiModelProperty(value = "是否显示浓度")
    private Integer showThick;
    
    @ApiModelProperty(value = "是否显示流速")
    private Integer showFlow;
    
    public Integer getShowThick()
    {
        return showThick;
    }

    public void setShowThick(Integer showThick)
    {
        this.showThick = showThick;
    }

    public Integer getShowFlow()
    {
        return showFlow;
    }

    public void setShowFlow(Integer showFlow)
    {
