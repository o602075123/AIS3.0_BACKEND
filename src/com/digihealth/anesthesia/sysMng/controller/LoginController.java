...
public class LoginController extends BaseController {
	...
	public String login(@ApiParam(name = "username", value = "用户名") @RequestParam("username") String username, @ApiParam(name = "password", value = "密码") @RequestParam("password") String password,@ApiParam(name = "logionBeid", value = "局点id")@RequestParam("logionBeid") String logionBeid,@ApiParam(name = "module", value = "模块")@RequestParam("module") String module) {
...
//		List<BasMenu> menusAll = basMenuService.selectEntityList(params);
		List<BasMenu> menuList = basMenuService.findMenuByRoleId(user2.getRoleId(), beid, module);
		String urlString = "";
		...
		BasBusEntity bis = basBusEntityService.selectBusEntityById(beid);
		if(null!=bis){
			user2.setTitlePath(bis.getTitlePath());
		}
