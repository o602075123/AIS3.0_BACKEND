...
public class OperationMgr {
    ...
    public static boolean init(String operId) {
        ...
        if (client == null) {
            ...
            String remoteHost = Global.getConfig("remoteHost").toString().trim();
            int remotePort = SysUtil.strParseToInt(Global.getConfig("remotePort").toString().trim());
...
//	        }
    ...
    public static void endOperation( String operId) {
        ...
        client.close();
        client = null;//将client设置为空
        
        logger.info("endOperation------将client设置为空！"); 
    }
