...
public interface BasMonitorDisplayDao {
    ...
    public List<BasMonitorDisplay> searchMonitorDisplayList(@Param("regOptId")String regOptId,@Param("pageNo")Integer pageNo,
    		@Param("pageSize")Integer pageSize,@Param("observeIds")List<String> observeIds,@Param("inTime")String inTime,@Param("outerTime")String outerTime);
    
    public Integer searchMonitorDisplayListTotal(@Param("regOptId")String regOptId,
    		@Param("observeIds")List<String> observeIds,@Param("inTime")String inTime,@Param("outerTime")String outerTime);
    ...
    public void deleteByEndTime(@Param("time")String time,@Param("regOptId")String regOptId);
    
    public Date findEndTime(@Param("regOptId") String regOptId);
    
    public List<BasMonitorDisplay> searchDisplayListByTimeAndId(@Param("regOptId")String regOptId,@Param("observeId") String observeId,@Param("startTime")Date startTime,@Param("endTime")Date endTime);
    
    public List<BasMonitorDisplay> selectByOperTime(@Param("time")String time,@Param("regOptId")String regOptId);
    
    public List<BasMonitorDisplay> selectByEndTime(@Param("time")String time,@Param("regOptId")String regOptId);
}