...
public interface StatisticsDao extends BaseDao {
	...
	public List<SearchDeptOperatCountByOptlev>  searchDeptOperatCountByOptlev(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public List<SearchDeptOperatCountByAsalev>  searchDeptOperatCountByAsalev(@Param("searchFormBean") SearchFormBean searchFormBean);
	...
	public List<AnaesDocObserveTimeCount> searchDeathCountByDept(@Param("filters") List<Filter> filters, @Param("beid") String beid);
	...
	public List<StaticDeptCountByAnalgesic> searchDeptCountByAnalgesicQNZ(@Param("searchFormBean") SearchFormBean searchFormBean);
	...
	public List<SearchOperByASALevel> searchDeathOperByASALevel(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public Integer searchOperByAnalgesic(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public Integer searchOperByAnalgesicQNZ(@Param("searchFormBean") SearchFormBean searchFormBean);
	...
	public List<SearchOperFormBean> searchToICUOperQNZ(@Param("searchFormBean") SearchFormBean searchFormBean, @Param("beid") String beid);
	
	public List<SearchOperFormBean> searchCancleOperAfterAnaes(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public List<SearchOperFormBean> searchOptVenipunctyreList(@Param("searchFormBean") SearchFormBean searchFormBean);
	 ...
	 * @return
	 */
	public List<WorkingTimeFormBean> searchLgNurseQmWorkingTimeHBGZB(@Param("startTime") String startTime,
			@Param("endTime") String endTime,@Param("loginName")String loginName, @Param("beid") String beid);
	/**
	 * 首页中  护士局麻工作量(湖北葛洲坝)
	 * @param startTime
	 ...
	 * @return
	 */
	public List<WorkingTimeFormBean> searchLgNurseJmWorkingTimeHBGZB(@Param("startTime") String startTime,
			@Param("endTime") String endTime,@Param("loginName")String loginName, @Param("beid") String beid);

	
	public Integer searchHomeQMTimes(@Param("startTime") String startTime,@Param("endTime") String endTime,@Param("loginName")String loginName, @Param("beid") String beid);
	
	public Integer searchHomeNurseJMTimes(@Param("startTime") String startTime,@Param("endTime") String endTime,@Param("loginName")String loginName, @Param("beid") String beid);
	...
	public SearchAnesTypeFormBean countAnesNumByCombineAnaes(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public SearchAnesTypeFormBean countAnesNumByLocalAnaes(@Param("searchFormBean") SearchFormBean searchFormBean);
	...
	public List<SearchOperFormBean> searchQmFjgIcuNumQNZ(@Param("searchFormBean") SearchFormBean searchFormBean);
	...
	public List<GetPharmacyReportFormBean> getPharmacyReport(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public int searchOperNoStartAt9(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public int searchOperNoEndAt18(@Param("searchFormBean") SearchFormBean searchFormBean);
	
	public List<SearchAnesDetailFormbean> searchAnesDetailByCond(@Param("cond") String cond, @Param("beid") String beid, @Param("anesType1") String anesType1, @Param("anesType2") String anesType2, @Param("startTime") String startTime, @Param("endTime") String endTime);
	
	public List<SearchAnesDetailFormbean> searchLocalAnesDetail(@Param("beid") String beid, @Param("anesType") String anesType, @Param("startTime") String startTime, @Param("endTime") String endTime);
	
	public List<SearchOperFormBean> searchOperByConsciousness(@Param("searchFormBean") SearchFormBean searchFormBean,@Param("coma") String coma);
	
	public List<SearchOperFormBean> searchOperByHoarse(@Param("searchFormBean") SearchFormBean searchFormBean,@Param("hoarse") String hoarse, @Param("tube") String tube);
}
