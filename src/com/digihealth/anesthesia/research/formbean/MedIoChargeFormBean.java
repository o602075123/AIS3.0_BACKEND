...
public class MedIoChargeFormBean implements Serializable {
	...
	@ApiModelProperty(value = "收费项目")
    private List<DocPackagesItem> anaesList;

	public List<DocPackagesItem> getAnaesList()
    {
        return anaesList;
    }

    public void setAnaesList(List<DocPackagesItem> anaesList)
    {
        this.anaesList = anaesList;
    }
