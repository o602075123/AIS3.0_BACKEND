...
public class QCManagerService extends BaseService {
	...
	public List<SearchOperFormBean> searchToICUOperQNZ(SearchFormBean searchBean) {
        return statisticsDao.searchToICUOperQNZ(searchBean, getBeid());
    }
	...
	public List<SearchOperFormBean> searchQmFjgIcuNumQNZ(SearchFormBean searchFormBean){
        return statisticsDao.searchQmFjgIcuNumQNZ(searchFormBean);
    }
