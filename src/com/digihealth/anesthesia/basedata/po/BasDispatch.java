...
public class BasDispatch {
	...
	private List<String> instrnurseIdList;
    ...
    public List<String> getInstrnurseIdList()
    {
        return instrnurseIdList;
    }

    public void setInstrnurseIdList(List<String> instrnurseIdList)
    {
        this.instrnurseIdList = instrnurseIdList;
    }
