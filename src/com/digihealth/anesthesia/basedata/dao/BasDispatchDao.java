...
public interface BasDispatchDao extends CrudDao<BasDispatch>{
	 ...
	 * @return
	 */
	public List<BasDispatch> getDispatchListByOperateDate(@Param("operatDate") String operatDate, @Param("beid") String beid);
	...
	public List<PrintNoticeFormBean> getOperateInfoByInsideScreenQNZ(@Param("beid") String beid);
	/**
	 * 手术室外屏显示信息
	 * @param baseQuery
	 * @return
	 */
	public List<PrintNoticeFormBean> getOperateInfoByOutsideScreen(@Param("beid") String beid);
    ...
    public int searchAllDispatchListTotal(@Param("baseQuery")BaseInfoQuery baseQuery);
    
    public List<SearchListScheduleFormBean> searchAllDispatchListNHFE(@Param("baseQuery")BaseInfoQuery baseQuery);
    
    public List<SearchListScheduleFormBean> searchAllDispatchListSYBX(@Param("baseQuery")BaseInfoQuery baseQuery);
    
    public List<SearchListScheduleFormBean> searchAllDispatchListQNZ(@Param("baseQuery")BaseInfoQuery baseQuery);
    ...
    public List<SearchDispatchFormBean> printSchudleHBGZB(@Param("baseQuery")BaseInfoQuery baseQuery);
    
    public List<SearchDispatchFormBean> printSchudleQNZ(@Param("baseQuery")BaseInfoQuery baseQuery);
    /**
     * 取消手术安排数据
     * @param regOptId
     */
    public int cancelDispatch(@Param("regOptId") String regOptId);
    
    public int cancelDispatchQNZ(@Param("regOptId") String regOptId);
