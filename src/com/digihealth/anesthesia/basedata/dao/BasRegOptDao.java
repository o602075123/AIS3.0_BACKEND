...
public interface BasRegOptDao extends CrudDao<BasRegOpt>{
	...
	public List<SearchRegOptByRoomIdAndOperDateAndStateFormBean> searchCurUserRegOptNHFE(@Param("roomId")String roomId,@Param("operDate")String operDate,@Param("userId")String userId, @Param("beid") String beid, @Param("roleType")String roleType);
	
	public List<SearchRegOptByRoomIdAndOperDateAndStateFormBean> searchCurUserRegOptHBGZB(@Param("roomId")String roomId,@Param("operDate")String operDate,
			@Param("userId")String userId, @Param("beid") String beid,@Param("roleType")String roleType);
	 ...
	 * @return
	 */
	public SearchRegOptByIdFormBean searchApplicationById(@Param("id") String id,@Param("beid") String beid);
	...
	public List<SearchMyOperationFormBean> searchNoArchiveRegOpt(@Param("time")String time, @Param("beid")String beid);
	...
	public int updateIsLocalAnaes(@Param("isLocalAnaes")int isLocalAnaes,@Param("regOptId")String regOptId);
    ...
    //南华局点
    public Long selectHisToRegOptNHFE();

    public BasRegOpt searchRegOptByReservenumber(@Param("preengagementnumber")String preengagementnumber,@Param("beid")String beid);

    public List<SearchRegOptByLoginNameAndStateFormBean> searchAllOptList(@Param("filter") String filter, @Param("searchConditionFormBean") SearchConditionFormBean searchConditionFormBean);
    
    public int searchTotalAllOptList(@Param("filter") String filter, @Param("searchConditionFormBean") SearchConditionFormBean searchConditionFormBean);
    
    public void updateRegOptBaseInfo(BasRegOpt record);
